 ...
 ## Project: 
This lab is made to simulate a real cyber attack and endpoint detection and response. Utilizing Eric Capuano's guide online, I will be using cloud hosted virtual machines to simulate the threat & victim machines. The attacking Linux Ubuntu machine will utilize 'Sliver' as a C2 framework to attack a Windows endpoint machine, which will be running 'LimaCharlie' as an EDR solution.
